...
<%@ page import ="com.kh.semi.likeList.VillaTypeDAO" %>
<%@ page import ="com.kh.semi.likeList.OneRoomDAO" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="EUC-KR">
...
<body>
                ...
                <div class="type_box">
                    <div class="type_list">
                        <ul class="type">
                            ...
                            <li>오피스텔</li>
                            <li><a href="OneRoomType.jsp" style="color: #6190E8;">원룸</a></li>
                            <li>주택</li>
                        </ul>
                        <hr style="width: 96%;">
                    </div>
    ...
    <% 
	    ...
	    List<LikeRealestate> LikeRealestates = oneRoomDAO.getAllLikeRealestates();
