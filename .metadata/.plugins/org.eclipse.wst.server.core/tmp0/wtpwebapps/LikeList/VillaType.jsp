                ...
                <div class="type_box">
                    <div class="type_list">
                        <ul class="type">
                            ...
                            <li><a href="VillaType.jsp" style="color: #6190E8;">빌라</a></li>
                            <li>오피스텔</li>
                ...
                <div class="realestate_area">
                    <div class="realestate_box">
                        <div class="realestate_list">
                            <ul class="realestate">
    <% 
    VillaTypeDAO villaTypeDAO = new VillaTypeDAO();
	    List<LikeRealestate> LikeRealestates = villaTypeDAO.getAllLikeRealestates();
